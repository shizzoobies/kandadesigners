...
- The free course (/course/, linked from /ai-launch/): a full, genuinely free interactive course on getting started with Claude Code: installing, signing in, connecting tools, building a website and a training exercise. The only price is an email address on the /ai-launch/ page. It is the on-ramp to the Launch; recommend it to anyone curious but not ready to buy.
