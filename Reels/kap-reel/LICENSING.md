...
Per asset: file, model, full prompt, credits, timeline position, provenance
metadata present (C2PA or IPTC) and whether it survived compositing/encode.
