...
const root = 'public/training-samples/nutrition/';
const varsPath = process.env.NUTRITION_VARS_PATH || 'D:/K & A Performance Site/.dev.vars';
...
const scripts = context.window.nutritionNarration;
