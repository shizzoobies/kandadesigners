...
export const samples = [
  ...
  // line on the first screen and in the ending.
  {
    ...
    backdrop: '/images/training/backdrops/sample-nutrition.jpg?v=2',
    kind: 'Short module',
  ...
  },
  {
    ...
    backdrop: '/images/training/backdrops/sample-strength.jpg?v=2',
    kind: 'Short module',
    vertical: 'Health and wellness',
    minutes: 10,
    what: 'A ten-minute beginner strength workshop: explore movement patterns, notice effort, compare coaching cues and sketch a first week with room for recovery.',
    // Meta description only; the card and page copy above stay as approved.
    meta: 'Explore movement patterns, compare coaching cues and sketch a first week in this illustrated strength workshop with optional audio and a printable guide.',
    demonstrates: 'An illustrated strength workshop with a welcoming coach, practical movement examples and optional narration. Original demonstration content; general education, not a personal exercise program.',
    technique: 'Explore movement patterns, sort everyday movements, compare coaching cues, adjust effort and assemble a first-week practice plan.',
    accessibility: 'Keyboard controls, matching audio transcripts, text explanations for illustrations, a readable workbook and reduced-motion support.',
    built: 'Custom HTML, CSS and JavaScript with local illustrations, recorded audio and website completion reporting.',
  },
  {
    slug: 'heat-done-well',
    ...
    backdrop: '/images/training/backdrops/sample-sauna.jpg?v=2',
    kind: 'Microlearning',
    vertical: 'Health and wellness',
    minutes: 8,
    what: 'An eight-minute sauna workshop: understand heat, plan the whole visit, recognize warning signs and read health claims with perspective.',
    meta: 'Understand sauna heat, plan a considered visit and recognize warning signs in this illustrated workshop with optional audio, visual practice and a takeaway.',
    demonstrates: 'An illustrated cedar-and-cream learning space with a wellness guide and optional narration. Original demonstration content; general education, not medical advice or personalized clearance.',
    technique: 'Compare heat sources, explore effects and evidence, assemble a session itinerary, and practice responses to changing conditions.',
    accessibility: 'Keyboard controls, matching audio transcripts, text explanations for illustrations, a readable workbook and reduced-motion support.',
    built: 'Custom HTML, CSS and JavaScript with local illustrations, recorded audio and website completion reporting.',
  },
  {
